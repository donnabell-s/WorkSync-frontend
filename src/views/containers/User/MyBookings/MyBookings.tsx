  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-3">
        <h1 className="text-lg font-semibold mb-4 flex flex-row items-center gap-1"><CiFilter size={23}/>Filter</h1>

        {/* Date Filter */}
        <div className="mb-4">
          <h2 className="text-md font-medium mb-2">Date</h2>
          <div className="flex gap-4 flex-col pl-6">
            {['asc', 'desc', 'all'].map((order) => (
              <button
              key={order}
              className="transition font-medium text-left"
        ...
        <div className="mb-6">
          ...
          <div className="flex gap-4 flex-wrap flex-col pl-6">
        ...
        <button
          className="w-full bg-[#0D9488] uppercase text-white py-2 px-4 rounded hover:bg-emerald-600 transition"
      ...
      <div className="ml-67 p-10 flex flex-col gap-6">
        ...
        <UserBookingList dateOrder={dateOrder} statusFilter={statusFilter} />
      </div>
    </div>
  );
};
